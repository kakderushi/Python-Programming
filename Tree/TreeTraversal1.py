...
# Output:
# Pre Order Traversal is: 1 2 4 5 3 6 7   DLR Data left right
# In Order Traversal is: 4 2 5 1 6 3 7    LDR  left data right
# Post Order Traversal is: 4 5 2 6 7 3 1   LRD left right data
